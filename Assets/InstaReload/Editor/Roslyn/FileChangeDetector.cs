    ...
    internal static class FileChangeDetector
    {
        ...
        internal static void ReplayCachedPatches()
        {
            try
            {
                ...
                // patches again would repeat the crash on every Play Mode entry, so quarantine
                // instead - the alternative is the user losing unsaved work repeatedly with no
                // indication why.
                ...
                // Only patches that survived to a clean Play Mode exit are replayable. A patch that
                ...
                // Reaching here proves replay did not take the Editor down, so clear the sentinel.
                // Left in place, it tells the NEXT entry that replay crashed.
            ...
            catch (Exception ex)
            {
                ...
                // to avoid quarantining over a recoverable failure.
                PatchHistoryStore.EndReplayAttempt();
